...
data/simpleone_cmds.o: data/simpleone_cmds.s
	as -g -o data/simpleone_cmds.s data/simpleone_cmds.o

calc_simpleone: calc.o or.o xor.o lower.o data/simpleone_cmds.o
	ld -g -o calc.o or.o xor.o lower.o data/simpleone_cmds.o calc_simpleone
